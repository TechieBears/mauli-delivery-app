...
export const VendorIdentityStep = ({ data, errors, onChange, phone, phoneLocked, showEmail }) => (
  <>
...
export const VendorBankStep = ({ data, errors, onChange }) => (
  <>
    <Text style={styles.sectionTitle}>Bank Details</Text>
    <Text style={styles.sectionDesc}>
      Provide your banking information for secure and timely payments from buyers.
    </Text>
    <FormField
      label="Bank Name"
      value={data.bankName}
...
export const VendorKycStep = ({ data, errors, onChange }) => (
  <>
    <Text style={styles.sectionTitle}>KYC Documents</Text>
    <Text style={styles.sectionSubtitle}>Business Details</Text>
    <FormField
    ...
    <TouchableOpacity
      ...
      <Text style={styles.checkboxLabel}>
        ...
        <Text style={styles.link}>
          {role === 'customer' ? 'Customer' : 'Vendor'} Terms & Conditions
        </Text>
      </Text>
    </TouchableOpacity>
